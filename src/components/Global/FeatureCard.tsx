...
const FeatureCard = ({title, icon, desc, subDesc}: Props) => {
    return (
        <div className="relative border dark:border-zinc-800 border-zinc-200 overflow-hidden rounded-xl">
            ...
            <div className="h-full card-content relative z-10 bg-gradient-to-br to-30% from-transparent to-black  pt-10 flex items-center justify-center flex-col gap-10">
                ...
                <div className="flex-2/3 text-content border-t border-zinc-100 dark:bg-zinc-900/50 dark:border-zinc-800 p-5">
